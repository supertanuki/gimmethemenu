...
use TE\Bundle\MainBundle\Form\Type\ProjectResponseType;
use TE\Bundle\MainBundle\Entity\Project;
use TE\Bundle\MainBundle\Entity\ProjectResponse;
...
class ProjectController extends Controller
{
    ...
    private function getCategories()
    {
        return $this->getDoctrine()
            ->getRepository('TEMainBundle:Category')
    ...
    public function showAction($slug_category, $slug_project)
    {
        ...
        if ($this->getUser()) {
            ...
            $projectResponses = $this->getDoctrine()
                ->getRepository('TEMainBundle:ProjectResponse')
                ->findBy(
     ...
     * @Method("GET")
     * @Template("TEMainBundle:ProjectResponse:edit.html.twig")
     */
    public function editAction($id)
    {
        ...
        $projectResponse = $em->getRepository('TEMainBundle:ProjectResponse')->find($id);
        if (!$projectResponse) {
